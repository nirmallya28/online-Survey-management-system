...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=survey&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
...
echo '<form action="update.php?q=survey&step=2&eid='.$eid.'&n='.$sn.'&t='.$total.'&qid='.$qid.'" method="POST"  class="form-horizontal">
<br />';
...
<tr style="color:red"><td><b>S.N.</b></td><td><b>survey</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td><td><b>Score</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
$r=$row['sahi'];
$qa=$row['level'];
$q23=mysqli_query($con,"SELECT title FROM survey WHERE  eid='$eid' " )or die('Error208');
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Nir.jpg" width=100 height=100 alt="Nirmallyadeb Ray" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Nirmallyadeb Ray </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917797586630</h4>
		<h4 style="font-family:'typo' ">nirmallyaray7@gmail.com</h4>
		<h4 style="font-family:'typo' ">IEM SALTLAKE</h4></div></div>
		</p>
      </div>
