...
<div class="col-md-10">
<a href="mailto:nirmallyaray7@gmail.com" style="color:#000000">nirmallyaray7@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Nirmallya Ray</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917797586630</h4>
		<h4 style="font-family:'typo' ">Nirmallyadeb Ray</h4>
		<h4 style="font-family:'typo' ">Institute of Engineering and Management,Saltlake,kolkata</h4></div></div>
		</p>
      </div>
      <div class="row">
		<div class="col-md-4">
		 <img src="image/aditya.png" width=100 height=100 alt="Aditya kumar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Aditya kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917337873721</h4>
		<h4 style="font-family:'typo' ">Aditya Kumar</h4>
		<h4 style="font-family:'typo' ">Institute of Engineering and Management,Saltlake,kolkata</h4></div></div>
		</p>
      </div>
